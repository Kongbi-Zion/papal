      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="max-w-md flex justify-center mx-auto mt-12">
          <Link href="https://wa.me/237222223456" target="_blank" rel="noopener noreferrer">
            <Button className="bg-primary hover:cursor-pointer w-fit hover:bg-green-600 text-white font-semibold py-5 px-6 rounded-lg transition-all duration-200 flex items-center justify-center space-x-3">
