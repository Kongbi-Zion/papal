                ...
                <div className="text-left mb-16 max-w-3xl">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-start">
                    <Link href={`/${locale}/services`}>
                      <Button size="lg" className="text-white hover:cursor-pointer hover:opacity-90 px-10 py-10 font-open-sans font-bold text-lg bg-primary whitespace-normal text-center">
                        {t('journeyButton')}
